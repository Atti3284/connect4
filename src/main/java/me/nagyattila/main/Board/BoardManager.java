...
public class BoardManager {
    ...
    public void loadBoardFromFile(String filePath) throws IOException {
        File file = new File(filePath);
        if (!file.exists()) {
            System.out.println("A fájl nem található. Üres pálya lesz használva.");
            return;
        }
    ...
    public void saveBoardToFile(String filePath) throws IOException {
...
public class BoardManager {
    ...
    public void loadBoard(char[][] loadedBoard) {
        for (int row = 0; row < ROWS; row++) {
            System.arraycopy(loadedBoard[row], 0, board[row], 0, COLUMNS);
        }
    }
}
